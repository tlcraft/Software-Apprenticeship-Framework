...
If you do work through the topics listed below, while you won't remember every detail of all of them, the bits and pieces you do retain will help in the future when working on a project that does use them. Beyond that these topics will fill your "toolbox" with concepts you may not have learned otherwise which can be applied elsewhere when the time is right. Reviewing the topics will broaden your perspective and help you see the bigger picture and how everything fits together. If nothing else you may find a particular topic very interesting and fun and decide to pursue it over the others throughout your career.
...
* Technical analysis for trade-off decisions
  ...
  * [Quality, cost, delivery](https://en.wikipedia.org/wiki/Quality,_cost,_delivery)
* Simple Design
...
Here is a list of some of the project assignments which 8th Light (a prominent company focused on clean code and apprenticeships) uses during their apprenticeship program.  
